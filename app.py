...
def train_model():
    ...
    for user in userlist:
        ...
        #   faces.append(resized_face.ravel())    #vector đặc trưng (50x50x3) = mảng 1d
            labels.append(user)
...
def start():
    if 'face_recognition_model.pkl' not in os.listdir('data'):
        return render_template('giaodien.html',totalreg=totalreg(),datetoday2=datetoday2,mess='There is no trained model in the data folder. Please add a new face to continue.') 
